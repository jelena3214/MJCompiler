...
public class NamespacesDecl extends NamespaceList {

    private NamespaceList NamespaceList;
    private NamespaceDecl NamespaceDecl;

    public NamespacesDecl (NamespaceList NamespaceList, NamespaceDecl NamespaceDecl) {
