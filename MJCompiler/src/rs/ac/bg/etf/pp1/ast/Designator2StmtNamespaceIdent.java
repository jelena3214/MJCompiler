...
public class Designator2StmtNamespaceIdent extends Designator2Stmt {

    private String I1;
    private DesignatorOrList DesignatorOrList;

    public Designator2StmtNamespaceIdent (String I1, DesignatorOrList DesignatorOrList) {
        this.I1=I1;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("Designator2StmtNamespaceIdent(\n");
